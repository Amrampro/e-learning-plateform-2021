                        ...
                        <table class="tab display cell-border stripe container-fluid table table-striped table-bordered col-sm-12">
                            ...
                            <tbody>
                              ...
                              while($trouve = $query -> fetch()){
								...
								} else if($trouve['suspended'] == 2) {
									$status = "Do not give course";
                                    $status_action="id_re_sus_course";
								} else {
									$status = "Not specified";
								}

                                $sql = $db -> query("SELECT * FROM courses WHERE id_prof = '$id_user'");
                                $found_course = $sql -> fetch();
                                $course = $found_course["name"];
